...
namespace Umbraco.Core.Persistence.UnitOfWork
{
    ...
    public class PetaPocoUnitOfWorkProvider : IDatabaseUnitOfWorkProvider
    {
        ...
        public PetaPocoUnitOfWorkProvider()
            : this(new DefaultDatabaseFactory(Constants.Database.UmbracoConnectionName, LoggerResolver.Current.Logger))
        {
        ...
        public PetaPocoUnitOfWorkProvider(ILogger logger)
            : this(new DefaultDatabaseFactory(Constants.Database.UmbracoConnectionName, logger))
        {
