...
namespace Umbraco.Web.Install.InstallSteps
{
    ...
    internal class DatabaseInstallStep : InstallSetupStep<object>
    {
        ...
        internal static void HandleConnectionStrings()
        {
            ...
            {
                var ex = new ArgumentNullException(string.Format("ConfigurationManager.ConnectionStrings[{0}]", Constants.Database.UmbracoConnectionName), "Install / upgrade did not complete successfully, umbracoDbDSN was not set in the connectionStrings section");
